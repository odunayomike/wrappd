...
// figma node: 112:882 curation-form
export function CurationForm(_p = {}) {
  const props = _p;
  return (
    <div className={props.className} style={{
      ...
      <div data-section="hero" style={{
        ...
        flexDirection: "column",
        gap: 24,
        padding: "clamp(60px, 10vw, 120px) clamp(20px, 6vw, 80px) clamp(48px, 8vw, 90px)",
        alignItems: "center",
        flexWrap: "nowrap",
        ...
        <div style={{
          ...
          <span data-heading="hero" style={{
            ...
            color: "var(--primary-burgundy)",
            flexShrink: 0,
          }}>Tell us about your person. We'll do the rest.</span>
          <span data-text-block style={{
            ...
            flexShrink: 0,
          }}>Five quick questions — two minutes, tops. Then we get to work designing a box that could only be theirs.</span>
        </div>
      </div>
      <div data-section="content" style={{
        ...
        flexDirection: "column",
        gap: 48,
        padding: "clamp(32px, 6vw, 80px) clamp(16px, 4vw, 80px) clamp(48px, 8vw, 100px)",
        alignItems: "center",
        flexWrap: "nowrap",
        boxSizing: "border-box",
        alignSelf: "stretch",
        ...
        <div data-text-block style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: "var(--burgundy-deep-wine)",
                flexShrink: 0,
              }}>Q1: Who's the lucky person?</span>
              <span style={{
                position: "relative",
                opacity: 0.6,
                fontFamily: "Geist, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                ...
                color: "var(--primary-burgundy)",
                flexShrink: 0,
              }}>Your sister, your best friend, your boss — and yes, "me" is a valid answer.</span>
            </div>
            <input placeholder="e.g. My best friend, Amaka" style={{
                position: "relative",
                height: 52,
                borderRadius: 8,
                backgroundColor: "var(--tan-ivory)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: "var(--burgundy-deep-wine)",
                flexShrink: 0,
              }}>Q2: What are we celebrating?</span>
              <span style={{
                position: "relative",
                opacity: 0.6,
                fontFamily: "Geist, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                ...
                color: "var(--primary-burgundy)",
                flexShrink: 0,
              }}>"No reason, she's just amazing" counts as an occasion here.</span>
            </div>
            <input placeholder="e.g. Her 30th birthday" style={{
                position: "relative",
                height: 52,
                borderRadius: 8,
                backgroundColor: "var(--tan-ivory)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: "var(--burgundy-deep-wine)",
                flexShrink: 0,
              }}>Q3: Tell us three things about them</span>
              <span style={{
                position: "relative",
                opacity: 0.6,
                fontFamily: "Geist, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif",
                ...
                color: "var(--primary-burgundy)",
                flexShrink: 0,
              }}>What they love, how they spend Saturdays, that thing they always say — anything that makes them them.</span>
            </div>
            <textarea placeholder="e.g. Obsessed with skincare, always cold, tea over coffee…" rows={4} style={{
                position: "relative",
                height: 120,
                borderRadius: 8,
                backgroundColor: "var(--tan-ivory)",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: "var(--primary-burgundy)",
                flexShrink: 0,
              }}>We make magic at every level — this just tells us which wand to use.</span>
            </div>
            <div style={{
              position: "relative",
              display: "flex",
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{
                ...
                color: "var(--primary-burgundy)",
                flexShrink: 0,
              }}>Date and delivery area — we'll handle the rest.</span>
            </div>
            <input placeholder="e.g. August 2, Lekki Phase 1" style={{
                position: "relative",
                height: 52,
                borderRadius: 8,
                backgroundColor: "var(--tan-ivory)",
          ...
          <div style={{
            ...
            <span style={{
              ...
              color: "var(--burgundy-deep-wine)",
              flexShrink: 0,
            }}>{"Rather talk it through? "}<span style={{ color: "rgb(184,87,106)", textDecoration: "underline" }}>{"Book a 15-minute call"}</span>{" or "}<span style={{ fontWeight: 600, color: "rgb(37,211,102)", textDecoration: "underline" }}>{"chat with us on WhatsApp"}</span>{"."}</span>
          </div>
        </div>
      </div>
